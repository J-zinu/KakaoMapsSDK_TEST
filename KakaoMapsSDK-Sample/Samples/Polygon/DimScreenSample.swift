...
class DimScreenSample: APISampleBaseViewController {
    ...
    func createDimScreenShape() {
        ...
        let shapeStyle = PolygonStyle(styles: [
            PerLevelPolygonStyle(color: UIColor(red: 0.0, green: 0.0, blue: 0.0, alpha: 0.0), strokeWidth: 2, strokeColor: UIColor.blue, level: 0),
            PerLevelPolygonStyle(color: UIColor(red: 0.0, green: 0.0, blue: 0.0, alpha: 0.0), strokeWidth: 2, strokeColor: UIColor.red, level: 15)
        ])
        ...
        let outter = Polygon(exteriorRing: Primitives.getCirclePoints(radius: 1000.0, numPoints: 90, cw: true), hole: nil, styleIndex: 0)
...
//        options.polygons.append(inner)
        ...
        let effect = WaveAnimationEffect(datas: [
            WaveAnimationData(startAlpha: 0.8, endAlpha: 0.0, startRadius: 50000, endRadius: 50000, level: 0),
            WaveAnimationData(startAlpha: 0.8, endAlpha: 0.0, startRadius: 50000, endRadius: 50000, level: 15)
        ])
